    ...
    <View style={styles.root}>
      ...
      {!showInput ?
        <>
          ...
          <View style={styles.container}>
            ...
            {!isLoading ?
              <TouchableOpacity   onPress={startSpeechToText ? stopSpeechToText :startSpeechToText}>
                 <Image source={require('./Images/mic.png')} style={{height:50,width:40}} />
      ...
      <View style={styles.bottomBar}>
        <TouchableOpacity onPress={handleInputField}>
          ...
          {!showInput ?
           <Image source={require('./Images/go-back-arrow.png')} style={{height:20,width:20}} />
            :
            <Image source={require('./Images/go-back-arrow.png')}  style={{height:20,width:20}}  />
