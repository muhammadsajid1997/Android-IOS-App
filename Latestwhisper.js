    ...
    axios
      ...
      .then(async function (response) {
        if (response) {
          ...
          const elapsedTime = sendendTime - sendstartTime;
          console.log(`sendAnswer API call took ${elapsedTime} milliseconds.`);
  ...
  const getAnswerVoice = async (text) => {
    ...
    axios
      ...
      .then(function (response) {
        ...
        const elapsedTimea = AnswerendTime - AnswerTime;
        console.log(
          `getAnswerVoice API call took ${elapsedTimea} milliseconds.`
        );
        setisloading(false);
        _stopRecognizing();
        const dirs = RNFetchBlob.fs.dirs;
